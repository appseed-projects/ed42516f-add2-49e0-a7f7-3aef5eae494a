...
- Timestamp: `2022-06-22 15:15`
- Build ID: `ed42516f-add2-49e0-a7f7-3aef5eae494a`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ed42516f-add2-49e0-a7f7-3aef5eae494a.git
$ cd ed42516f-add2-49e0-a7f7-3aef5eae494a
```
